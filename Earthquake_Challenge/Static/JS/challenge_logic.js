...
let streets = L.tileLayer('https://github.com/jrennr/Mapping_Earthquakes/blob/main/Earthquake_Challenge/Static/JS/config.js/styles/v1/mapbox/streets-v11/tiles/{z}/{x}/{y}?access_token={accessToken}', {
